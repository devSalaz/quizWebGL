...
const MrKrabs = ({ planeRef, planeSecondary, visible }) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "/assets/models/MrKrabs.glb"
  );
  ...
  return (
    <>
      <group ref={group} dispose={null} visible={visible}>
        <group name="Scene">
          <group
            name="Mr_Krabsobjcleanermaterialmergergles"
            rotation={[0, 0, 0]}
            scale={1}
          />
          <group
          ...
          >
            ...
            >
              <meshStandardMaterial
                map={materials.Sushi_Costume00_Mat.map}
...
export default MrKrabs;
useGLTF.preload("/assets/models/MrKrabs.glb");
